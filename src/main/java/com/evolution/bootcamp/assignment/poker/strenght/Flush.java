...
public class Flush extends HandStrength {
    public Flush(Hand hand, int base, int score) {
        super(hand, base, score);
    }

    /**
     * If tho hands are flush on the same value so comparing the value of
     * next cards after first card. It's because the cards are sorted descending here.
     *
